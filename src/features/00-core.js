...
const categoryArt = {
  ...
  "Nightlife": '<svg viewBox="0 0 48 48" fill="none" stroke="#191A19" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"><circle cx="24" cy="18" r="9" fill="#D8D4F5"/><path d="M15 18h18M24 9v18M18 12.5c4 2.3 8 2.3 12 0M18 23.5c4-2.3 8-2.3 12 0" stroke-width="1.3"/><path d="M24 27v5" stroke-width="1.5"/><path d="M11 39l8-9h10l8 9z" fill="#C7F3E8"/><path d="M15 39l6-9M33 39l-6-9" stroke-width="1.3"/><path d="M8 12l5 3M40 12l-5 3M9 27l5-2M39 27l-5-2" stroke="#FFC53D" stroke-width="2.2"/><circle cx="38" cy="8" r="2.4" fill="#FFC53D" stroke-width="1.2"/></svg>',
