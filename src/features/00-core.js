...
const categoryArt = {
  ...
  "Nightlife": '<svg viewBox="0 0 48 48" fill="none" stroke="#191A19" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"><path d="M14 39V18c0-4.4 4.2-8 10-8s10 3.6 10 8v21z" fill="#D8D4F5"/><path d="M20 39V23c0-2.2 1.6-4 4-4s4 1.8 4 4v16z" fill="#C7F3E8"/><path d="M10 39h28"/><path d="M9 18c2.2-2.8 4.8-4.6 8-5.6M39 18c-2.2-2.8-4.8-4.6-8-5.6" stroke="#FFC53D" stroke-width="2.2"/><path d="M37 8a5.5 5.5 0 0 1-6.8 6.8 6.7 6.7 0 1 0 6.8-6.8z" fill="#FFE3A0" stroke-width="1.5"/></svg>',
