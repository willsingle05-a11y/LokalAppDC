...
const categoryArt = {
  ...
  "Nightlife": '<svg viewBox="0 0 48 48" fill="none" stroke="#191A19" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"><path d="M13 18h22v13c0 5.5-4.9 9-11 9s-11-3.5-11-9z" fill="#D8D4F5"/><path d="M13 18c3 3 7 4.5 11 4.5S32 21 35 18" fill="#C7F3E8"/><path d="M18 30c3.5 2.5 8.5 2.5 12 0" stroke-width="1.6"/><path d="M19 13h10l-2 5h-6z" fill="#FFE3A0"/><path d="M35 9l1.2 2.7 2.8 1.2-2.8 1.2L35 17l-1.2-2.9-2.8-1.2 2.8-1.2z" fill="#FFC53D" stroke-width="1.2"/><circle cx="14" cy="10" r="2.4" fill="#00C897" stroke-width="1.3"/></svg>',
