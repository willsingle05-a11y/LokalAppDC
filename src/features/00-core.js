...
const categoryArt = {
  ...
  "Sports": '<svg viewBox="0 0 48 48" fill="none" stroke="#191A19" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"><circle cx="18" cy="19" r="8" fill="#FFC53D"/><path d="M10 19h16M18 11v16" stroke-width="1.3"/><path d="M12.5 13.5c3 2.5 3 8.5 0 11M23.5 13.5c-3 2.5-3 8.5 0 11" stroke-width="1.3"/><path d="M27 28c4.5-5 11-3.5 13 2 1.5 4-1.4 8.5-6 8.5-4.5 0-8-4-7-10.5z" fill="#C7F3E8"/><path d="M29 29c4 1.4 7.5 3.8 9.5 7" stroke-width="1.3"/><path d="M31 25l1.3 3.8M36 26.2l-2.4 3.3" stroke-width="1.3"/><path d="M10 35c4.5-3.5 11.5-3.5 16 0" fill="#FFE3A0"/><path d="M13 34c1.5 1.6 2.8 3 4.3 4.3M22.5 34c-1.5 1.6-2.8 3-4.3 4.3" stroke-width="1.3"/></svg>',
  ...
  "Culture": '<svg viewBox="0 0 48 48" fill="none" stroke="#191A19" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"><circle cx="24" cy="24" r="14" fill="#BFF2E0"/><path d="M10 24h28M24 10c4 4 6 8.5 6 14s-2 10-6 14M24 10c-4 4-6 8.5-6 14s2 10 6 14" stroke-width="1.5"/><path d="M15 15c4.5 2.8 13.5 2.8 18 0M15 33c4.5-2.8 13.5-2.8 18 0" stroke-width="1.5"/><path d="M37 8l1.1 2.4 2.4 1.1-2.4 1.1L37 16l-1.1-2.4-2.4-1.1 2.4-1.1z" fill="#FFC53D" stroke-width="1.2"/></svg>',
