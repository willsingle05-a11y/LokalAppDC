...
const categoryArt = {
  ...
  "Sports": '<svg viewBox="0 0 48 48" fill="none" stroke="#191A19" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"><circle cx="18" cy="19" r="9" fill="#FFC53D"/><path d="M9 19h18M18 10v18" stroke-width="1.3"/><path d="M12 12.5c3.3 3.2 3.3 9.8 0 13M24 12.5c-3.3 3.2-3.3 9.8 0 13" stroke-width="1.2"/><circle cx="31" cy="18" r="8" fill="#F7FAFC"/><path d="m31 12.5 3.8 2.8-1.5 4.5h-4.6l-1.5-4.5z" fill="#C7F3E8" stroke-width="1.1"/><path d="M27.2 15.3 24.8 14M34.8 15.3l2.4-1.3M33.3 19.8l1.7 2.7M28.7 19.8 27 22.5" stroke-width="1"/><circle cx="17" cy="31" r="8" fill="#F7FAFC"/><path d="M12.2 25.2c2.2 3.8 2.2 7.8 0 11.6M21.8 25.2c-2.2 3.8-2.2 7.8 0 11.6" stroke="#FF7B54" stroke-width="1.4"/><path d="M14.2 27.8l3-1.8M13.2 31.6l3.4-1.2M14.2 35.2l3 1.8M19.8 27.8l-3-1.8M20.8 31.6l-3.4-1.2M19.8 35.2l-3 1.8" stroke="#FF7B54" stroke-width="1"/><path d="M27 33c3.2-4.2 9.8-4.2 13 0-3.2 4.2-9.8 4.2-13 0z" fill="#D8D4F5"/><path d="M30 33h7M33.5 29.8v6.4" stroke-width="1.2"/></svg>',
