document.addEventListener("click", async event => {
  ...
  if (t.dataset.homeFilter) { state.discoverCategoryView = ""; state.discoverGenreFilter = ""; state.openFilterSheet = ""; state.feedShown = 10; state.homeFilter = t.dataset.homeFilter; if (!["all", "free"].includes(state.homeFilter)) state.filter.category = "All categories"; renderHome(); window.scrollTo({ top: 0, left: 0, behavior: "auto" }); app.scrollTop = 0; }
